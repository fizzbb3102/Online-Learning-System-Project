    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function deleteConfirm() {
                    location.href = '${pageContext.request.contextPath}/admin/posts';
            }
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form id="form" enctype="multipart/form-data" class="form-horizontal tasi-form" method="post" onsubmit="return validateForm()" action="${pageContext.request.contextPath}/admin/post/add">
                                        ...
                                        <div class="form-group" style="height: 200px; " >
                                            <label class="col-sm-2 control-label col-lg-2" for="inputSuccess">Thumnail </label>
                                            <div class="col-lg-10" onclick="">
                                                <img id="output" src="" alt="aa" height="200px"/>
                                                <br>
                                                <br>
                                                <input type="file" accept="image/*" onchange="loadFile(event)" name="thumbnail">
                                                <br>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="title" id="value" class="form-control" value="${data.title}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Brief Information</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="brief" class="form-control round-input" value="${data.briefInfor}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Content</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="content" class="form-control round-input" value="${data.content}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Featured</label>
                                            <div class="col-6 col-md-2">
                                                <input type="checkbox" name="featured" class="form-control round-input" value="${data.featured}" ${data.featured == "yes" ? "checked" :""}>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-offset-2 col-md-10">
                                        <button type="submit" class="btn btn-info" form="form" >Save</button>
                                        <button class="btn btn-primary" onclick="deleteConfirm()" >Cancel</button>
                                    </div>
                                </div>
                            </section>
                        </div>
