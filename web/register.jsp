                ...
                <div class="col-sm-4 col-sm-offset-8" >
                    <div class="login-form">
                        ...
                        <form action="register_controller" method="post">
                            ...
                            <input type="password" name="password" placeholder="Enter your Password" minlength="3" maxlength="12" required=""/>
                            <input type="password" name="repass" placeholder="Re-enter your Pasword" minlength="3" maxlength="12" required=""/>
                            <input name="phone" placeholder="Enter your Phone Number" minlength="6" maxlength="10" required=""/>
                            <select name="gender" id="gender" style="margin-bottom: 15px; padding: 8px" required="">
                                <option selected="" disabled="">Select gender</option>
                                <option value="0">Female</option>
                                <option value="1">Male</option>
                            </select>
                            <input name="dob" type="date" placeholder="Date of Birth" minlength="10" maxlength="10" required=""/>
