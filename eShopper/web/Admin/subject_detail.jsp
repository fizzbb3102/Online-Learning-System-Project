    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function deleteConfirm() {
                ...
                if (confirm) {
                    location.href = '/WebApplication2/admin/post/delete?id=${data.id}';
                }
                return confirm;
            }
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form id="form" enctype="multipart/form-data" class="form-horizontal tasi-form" method="post" action="${pageContext.request.contextPath}/admin/subject/detail">
                                        ...
                                        <div class="form-group" style="height: 200px; " >
                                            ...
                                            <div class="col-lg-10" onclick="">
                                                <img id="output" src="${pageContext.request.contextPath}/images/${data.thumbnail}" alt="aa" height="200px"/>
                                                <br>
                                                <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="title" id="value" class="form-control" value="${data.author.fullName}" disabled>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-6 col-md-2">
                                                <input type="checkbox" name="featured" class="form-control round-input"  ${data.featured == "yes" ? "checked" :""}>
                                            </div>
                                        </div>
                                        <div class="form-group">
