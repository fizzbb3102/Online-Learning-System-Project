    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function deleteConfirm() {
                ...
                if (confirm) {
                    location.href = '/WebApplication2/admin/user/delete?id=${data.id}';
                }
                return confirm;
            }
                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal tasi-form" method="post" action="${pageContext.request.contextPath}/admin/user/add">
                                        <div class="form-group">
                                            <c:if test="${param.success eq 1}">
                                                <p class="text-center" style="color: green; font-size: 18px">Updated successfully!</p>
                                            </c:if>
                                            <label class="col-sm-2 col-sm-2 control-label" style="color: red">${message}</label>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Full name</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="fullname" required id="value" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">User Title</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="" id="value" class="form-control" value="default" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Email</label>
                                            <div class="col-sm-10">
                                                <input type="email" name="email" class="form-control round-input" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Phone</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="phone" class="form-control round-input" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Password</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="pass" id="pass" class="form-control round-input" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-offset-2 col-md-10">
                                        <input type="submit" name="action" class="btn btn-info" form="form" value="Save"/>
