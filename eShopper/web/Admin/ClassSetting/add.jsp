                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal tasi-form" method="post" action="class_detail_controller?action=addPost">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="teacher" class="form-control round-input" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 col-sm-2 control-label">Note</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="note" class="form-control round-input" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
