                        ...
                        <div class="col-md-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form id="form" enctype="multipart/form-data" class="form-horizontal tasi-form" method="post" onsubmit="return validateForm()" action="${pageContext.request.contextPath}/admin/post/detail">
