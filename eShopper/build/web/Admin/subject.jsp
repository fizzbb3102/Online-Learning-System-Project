        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="col">
                                            <div class="row">
                                                    ...
                                                    <div class="col-6 col-md-4 form-group">
                                                        <select class="form-control" id="authorList" name = "authorId">
                                                            ...
                                                            <c:forEach items="${authorList}" var="item">
                                                                <option value="${item.id}" ${item.id == authorId ? 'selected' :''}>${item.fullName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    <div class="col-6 col-md-4 form-group">
                                                ...
                                                <div class="col-6 col-md-8 form-group">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" placeholder="Search by course name..." id="txtSearch" value="${search}"/>
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${data}">
                                                ...
                                                <tr>
                                                    <td>${item.getId()}</td>
                                                    <td>${item.getTitle()}</td>
                                                    <td>${item.getAuthor().getFullName()}</td>
                                                    <td>${item.getPrice()}</td>
                                                    <td>${item.getSalePrice()}</td>
                                                    <td>${item.getStatus()}</td>
                                                    <td><a href="${pageContext.request.contextPath}/admin/subject/detail?id=${item.getId()}"> view</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                                    <c:if test="${paging.size()>0}">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination">
                                                <li class="page-item">
                                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/subject?pageIndex=${pageIndex - 1 <= 0 ? paging.size (): pageIndex - 1}&authorId=${authorId}&status=${status}&search=${search}" aria-label="Previous">
                                                ...
                                                <c:forEach var="item" items="${paging}">
                                                    <li class="page-item ${item == pageIndex ? 'active':''}">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/subject?pageIndex=${item}&authorId=${authorId}&status=${status}&search=${search}">${item}</a></li>
                                                    </c:forEach>
                                                <li class="page-item">
                                                    <a class="page-link"  href="${pageContext.request.contextPath}/admin/subject?pageIndex=${pageIndex + 1 > paging.size() ? 1 : (pageIndex + 1)}&authorId=${authorId}&status=${status}&search=${search}" aria-label="Next">
                    ...
                    <form id="form-submit" action="${pageContext.request.contextPath}/admin/subject" method="GET">
