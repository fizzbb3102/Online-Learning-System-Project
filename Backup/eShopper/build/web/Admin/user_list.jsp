...
<html>
    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                                ...
                                                <form>
                                                    <div class="col-6 col-md-4 form-group">
                                                        <select class="form-control" id="roleList" name = "role">
                                                            ...
                                                            <option value="4" ${role == 4 ? 'selected' :''}>Sale</option>
                                            ...
                                            <div class="row">
                                                <div class="col-6 col-md-4 form-group">
                                                    Sort By:   <select class="form-control" id="sortByList" name = "sortBy">
                                                        <option value="fullname" ${sortBy == null || sortBy == "fullname" || sortBy == '' ? 'selected' :''}>FULL NAME</option>
                                    ...
                                    <label>
                                        ...
                                        <a href="${pageContext.request.contextPath}/admin/user/add" style="text-decoration: underline">ADD NEW</a>
                                    </label>
                                    <br>
                                    <br>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach var="item" items="${data}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="color: ${item.enabled == 1 ? 'green' : 'red'}">${item.enabled == 1 ? "Active" : "Deactive"}</td>
                                                    <td><a href="${pageContext.request.contextPath}/admin/user/detail?id=${item.aid}"> view</a></td>
                                                </tr>
                                    ...
                                    <c:if test="${paging.size()>0}">
                                        <nav aria-label="Page navigation example">
                                            <ul class="pagination">
                                                <li class="page-item">
                                                    <a class="page-link" href="${pageContext.request.contextPath}/admin/user?pageIndex=${pageIndex - 1 <= 0 ? paging.size (): pageIndex - 1}&sortBy=${sortBy}&search=${search}" aria-label="Previous">
                                                ...
                                                <c:forEach var="item" items="${paging}">
                                                    <li class="page-item ${item == pageIndex ? 'active':''}">
                                                        <a class="page-link" href="${pageContext.request.contextPath}/admin/user?pageIndex=${item}&sortBy=${sortBy}&search=${search}">${item}</a></li>
                                                    </c:forEach>
                                                <li class="page-item">
                                                    <a class="page-link"  href="${pageContext.request.contextPath}/admin/user?pageIndex=${pageIndex + 1 > paging.size() ? 1 : (pageIndex + 1)}&sortBy=${sortBy}&search=${search}" aria-label="Next">
                    ...
                    <form id="form-submit" action="${pageContext.request.contextPath}/admin/user" method="GET">
                        <input type="hidden" name="search" id="search" value="${search}">
                        <input type="hidden" name = "sortBy" id = "sortBy" value="${(sortBy == null || sortBy == "" )? "fullname":sortBy }">
        ...
        <script type="text/javascript">
                                                                ...
                                                                document.getElementById('roleList').addEventListener('change', function () {
