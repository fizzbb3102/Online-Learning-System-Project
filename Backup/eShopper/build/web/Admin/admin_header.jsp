<%-- 
    ...
    Created on : 17-Mar-2022, 10:55:21
    Author     : Zake
--%>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>${sessionScope.currentUser.fullname} <i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/login_controller"><i class="fa fa-ban fa-fw pull-right"></i> Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
