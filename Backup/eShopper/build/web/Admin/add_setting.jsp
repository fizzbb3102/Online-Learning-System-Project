                                ...
                                <div class="panel-body">
                                    <form id="form" class="form-horizontal tasi-form" method="post" onsubmit="return validateForm()">
                                        <div class="form-group">
                                            <c:choose>
                                                <c:when test="${param.success eq 1}">
                                                    <p class="text-center" style="color: green; font-size: 18px">Added successfully!</p>
                                                </c:when>
                                                <c:when test="${param.success eq 0}">
                                                    <p class="text-center" style="color: red; font-size: 18px">Added failed! Please check and try again!</p>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="order" class="form-control round-input" value="">
                                            </div>
                                        </div>
                                        <div class="form-group">
